...
var update = __webpack_require__(16)("c04a5e6c", content, false, {});
...
exports.default = {
  ...
  methods: {
    useAndroidApi: function useAndroidApi() {
      weex.requireModule('event').printLog('男哥无敌');
    }
  }
};
  ...
  return _c('div', {
    ...
    on: {
      ...
      "weex$tap": function($event) {
        $event.stopPropagation();
        return _vm.useAndroidApi($event)
      }
    }
  }, [_vm._v("调用android原声api")]), _vm._v(" "), _c('router-view')], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
